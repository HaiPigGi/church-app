...
function BeritaSideBar(){
    ...
    return(
        <>
            ...
            <aside id="sidebarBerita" className="absolute z-20 transition-all hidden md:block right-[-100%]  h-full md:static md:col-span-1 md:w-full md:h-full border-l-2 border-slate-500 shadow-xl bg-white py-5 px-5">
