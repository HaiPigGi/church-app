    ...
    <MainLayout>
      <div className="max-w-screen-xl mx-auto px-5 ">
        ...
        <div className="grid md:grid-cols-2 gap-10 mx-auto max-w-4xl mt-16">
          <h2 className="font-medium text-2xl text-gray-800">Contact Gereja ST. Markus Melak</h2>
          <p className="text-lg text-slate-500 ">Ada yang ingin dikatakan? Kami di sini untuk membantu. Isi formulir atau kirim email atau telepon.</p>
          ...
          <form id="form" action="" className="needs-validation">
            ...
            <div className="mb-5">
              <textarea
                ...
                className="w-full px-4 py-3 border-2 placeholder:text-gray-800 rounded-md outline-none h-36 focus:ring-4 border-gray-300 focus:border-gray-600 ring-gray-100"></textarea>
