...
const handleSubmit = (e) => {
    ...
    const convert = ({ tahun, jenis_kegiatan, images }) => {
        ...
        b.append('tahun', y); // Ambil tahun dari objek Date
        b.append('jenis_kegiatan', jenis_kegiatan);
        b.append('images', images);
        console.log('tahun : ',y)
    ...
    return (
        <div className="pt-20 flex flex-col items-center justify-center h-[60%] w-auto ">
            <label className="font-bold text-3xl mb-2 mt-10 min-[360px]:max-[765px]:text-xl">Tambahkan Dokumentasi</label>
            <form onSubmit={handleSubmit} className=" shadow-2xl opacity-50 h-[82vh] w-[100vh] p-5 ">
                {/* gambar */}
