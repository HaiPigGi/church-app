...
const Member = () => {
  ...
  return (
    <>
    <div className="container mx-auto mt-8 p-8 sm:p-8 flex max-[765px]:hidden">
    ...
    <div className='min-[765px]:hidden'>
      <label className='relative top-5 ml-10 text-2xl font-semibold  text-center'>Tambah Member</label>
      ...
      >
        <IoCloseCircleSharp  onClick={closeModal} className='h-8 w-8'></IoCloseCircleSharp>
         <form className='max-w-md mr-8'>
         {/* Input Nama */}
      ...
      contentLabel="Example Modal">
         <IoCloseCircleSharp  onClick={closeModalData} className='h-8 w-8'></IoCloseCircleSharp>
